    ...
    <div className="min-h-screen p-6 gap-y-6 flex flex-col justify-start w-full">
      ...
      <section className="w-full flex justify-center">
        ...
        {authLoading ? (
          ...
          <div className="text-sm mt-2 font-bold">Please login to use the AI feature</div>
        )}
        {askError ? <div className="mt-3 text-sm bg-rose-100 border border-rose-200 text-rose-900 p-3 rounded">{askError}</div> : null}
        {askResult ? (
          <div className="mt-3 text-sm">
            <div className="font-bold">Answer</div>
            <div className="mt-1 whitespace-pre-wrap">{askResult.answer || "(no answer)"}</div>
